...
Tanto de Morgan como Boole, de certa forma fundadores da interpretação subjetivista e frequentista da probabilidade,
...
mas dificultou seu acesso por estatísticos, de forma que vamos adaptar alguns termos e notações seguindo \cite{Zabell09} e 
\cite{Fitelson07}. 
...
e interpreta essa grandeza como a medida com a qual a evidência $e$ corrobora uma hipótese $h$ \cite{Zabell09}.
...
coerente de probabilidades subjetivas implica nos axiomas da probabilidade \cite{deFinetti37}.
...
breaking the Bayesian eggs'' \cite{Savage60}, e é refutado por I. J. Good \cite{Good92}. No entanto, os argumentos de Fisher
...
econômica de utilidade (veja por exemplo \cite{Friedman48} e \cite{Pfanzagl67}),
...
objetivo advogado por E. T. Jaynes \cite{Jaynes68}, que se utiliza do princípio da máxima entropia para determinar
...
é que há evidências de que a natureza da física quântica é intrinsecamente probabilística \cite{Gudder88}, ao contrário 
de fenômenos
...
the possibility that the evidence in the final results might be quite strong. Does this make sense?'' \cite{Royall97}

Enquanto alguns estatísticos vêem neste problema ``um uso ingênuo de p-valores'' \cite{Good92}, outros, como Richard Royall,
...
este princípio afirma que toda a informação contida em uma amostra está	contida na função de verossimilhança \cite{Birnbaum62}. 
...
Concluímos essa sessão com a conclusão de que a divisão entre 
...
otherwise be extremely unlikely.'' \cite{deFinetti2010}
