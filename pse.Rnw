...
\begin{center}
	  ...
	  trazem um tutorial e exemplos de uso deste pacote, disponível livremente na internet, no endereço
...
Chapter 1 introduces a brief investigation about the historical visions about the nature of
...
with a practical example of applying the described techniques to a model of structured population growth.
