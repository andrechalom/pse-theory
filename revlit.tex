...
but ranging from 6 to 143 \citep{Berthaume12},
and the number of
simulations ranged from 19 \citep{Nathan01} to 2000 \citep{Tiemeyer07}. 
Also, these works are from varied areas within ecology: applied plant 
ecology \citep{Confalonieri10, Tiemeyer07}, species richness 
\citep{Hamilton10}, epidemiology \citep{Shirley03} and food chain analysis
\citep{Duchesne03}, stressing that the method is useful on varied 
problems.
