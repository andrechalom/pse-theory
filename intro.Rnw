...
sensitivity of parameters\cite{Caswell89}. In the general case, however, there
...
the PSExplorer software\cite{Tung10}.
...
assume (see figure \ref{fig:Di} for examples); Berger \cite{Berger85} provides
