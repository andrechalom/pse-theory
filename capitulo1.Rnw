...
\begin{verbatim}
TODO p.12 a 17
Mesmo modelo, mesmo num de pars, parametros diferentes.
Correlacao entre parametros
Ex1: polinomio quadratico
Ex2: r-K

Par space, constraints 94
...
% TODO: Mostrar o caso y ~ a + bx - explorar o espaco de parametros a X b, com termo de correlacao entre a e b.
