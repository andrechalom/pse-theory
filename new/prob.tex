...
\subsection{Contra uma teoria axiomática}
...
a probabilidade de sortear cada número racional individualmente é zero; mas a probabilidade do evento certo é ao mesmo tempo 1, 
pelo axioma da unitariedade, e 0, pois é a soma de infinitos termos iguais a zero.
...
axioma de aditividade de Kolmogorov e ter regiões de probabilidade negativa.
