...
``I consider that [the term probability] presupposes a series;
whithn the indefinitely numerous ... ****** terminar
pag162 / 199 no doc online
*** DEFINICAO
...
a probabilidade medida se torna algo tangível e objetivo. No entanto, para qualquer problema interessante, essa objetividade
apenas se concretiza se concretiza apenas dentro da idealização de um dado modelo, para o qual temos que presumir uma certa
regularidade. 

Um experimento simples pode demonstrar um caso no qual a probabilidade, como definida acima, não converge para nenhum valor.
No primento experimento, jogue um dado regular e conte o número 6 como um sucesso e todos os outros como falha. Então, para
cada experimento posterior, verifique a frequência de sucessos obtidos até o momento. Se ela for menor do que 0.3, passe a 
considerar o número 6 como falha e todos os outros como sucesso. Se ela for maior do que 0.7, passe a considerar o número
6 como sucesso e os outros como falha. A série resultante desse experimento não converge: ela irá com alta probabilidade oscilar
entre os valores de 0.3 e 0.7.
