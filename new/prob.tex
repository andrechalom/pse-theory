...
Em seu trabalho de 1922, 
Fisher divide a tarefa da estatística em 3 classes de problemas: problemas de especificação, ou seja, a determinação da função
...
Fisher descreve ainda as seguintes propriedades que um estimador deve possuir. Embora as suas definições tenham sido
...
e fracassos da teoria Bayesiana é um tópico controverso	entre os que estudam a história da probabilidade \cite{Aldrich08,
Zabell09}. A nomenclatura é possivelmente confusa, já que o teorema 
