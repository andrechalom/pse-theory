...
``Though the notion of a random choice is not devoid of philosofical difficulties, I have a fairly clear idea of 
...
Edwards P 20
...
%Ao estimar a média de uma amostra composta por variáveis independentes e identicamente distribuídas, ${x_1, ..., x_n}$, 
%podemos utilizar duas estatísticas diferentes: o estimador $A(x) = x_1$
%O primeiro critério estabelece, por exemplo, que para estimar a média de uma amostra composta por
...
para escolha entre duas hipóteses concorrentes: a nula e a alternativa.	Um procedimento de teste de significância
