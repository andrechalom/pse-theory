...
de dados distintos, ao contrário da verossimilhança. A força de evidência absoluta para $\theta_1$ tomando o conjunto completo 
...
e é o caminho que vamos seguir nesta sessão.
